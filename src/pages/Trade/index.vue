<template>
  <div class="trade-container">
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{ orderInfo.totalAmount?.toFixed(2) }}</span></div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: "小李",
        consigneeTel: "15888108888",
        deliveryAddress: "尚硅谷学员中心",
      ...
      const result = await this.$TradeAPI.reqsubmitOrderApi(tradeNo, data)
